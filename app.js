...
//const pizzaToppings = ['Pineapple', 'Olives', 'Anchovies'];//got an error bc already defined
...
const userProfile= {
    [propertyName]: 19 //[] tells to use variable value or else it would be used as the key
...
console.log(sentence("bat", "black"));
